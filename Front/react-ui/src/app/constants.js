...
export const PROJECT_INFO_ID = "project-info-v141";
...
export const PROJECT_INFO = {
	...
	developer: "广分金科部",
	version: "V14.1",
	releaseTime: "2026-04-12T13:10:00+08:00",
	features: [
		"聊天支持上传图片与文件，服务端统一落库到 shared_space 并注入对话上下文。",
		"上传场景默认切换到 qwen3-omni-flash，修正模型名大小写导致的 404 问题。",
		"移动端聊天输入区恢复上传入口，并在生产 nginx 侧补齐 16MB 上传限制。",
	],
	info: "面向工作场景的企业智能问答与信息检索助手。",
	versionChange: "修复生产首问上传 413，并完成 14.1 发版收口。",
};
